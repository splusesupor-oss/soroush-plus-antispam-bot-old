...
# ثبت آمار پیام گروه
        ...
        if clean_text.strip() in help_commands:
            ...
            full_help_text = (
                ...
                "«🧹 \"پاکسازی خودکار\"»\n\n"
                # 🎮 کنترل سرگرمی به تفکیک گروه.  کل بخش داخل یک نقل‌قول
                # شیشه‌ای می‌رود و فقط دو خط عنوان Bold می‌شوند؛ خودِ
                # دستورها عمداً عادی می‌مانند تا کاربر بتواند کپی کند.
            ...
            quote_sections = [
                ...
                "صفر کردن تخلفات توسط مالک اصلی ربات یا مالک گروه\n«روی کاربر ریپلای کنید و بنویسید \"صفر\"»",
                "🗑️ حذف اخطار:\nبرای حذف اخطار داده‌شده به یک کاربر\n«روی پیام کاربر ریپلای کنید و بنویسید \"حذف اخطار\"»",
                # 🎮 کل بخش کنترل سرگرمی در یک نقل‌قول شیشه‌ای یکپارچه.
                "🎮 برای خاموش کردن بازی های عمومی\n\n"
                "سرگرمی خاموش\n\n"
                "🎮 برای روشن کردن بازی های روباه\n\n"
                "سرگرمی فعال",
