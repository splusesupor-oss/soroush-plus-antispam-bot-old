...
# ثبت آمار پیام گروه
        ...
        if clean_text.strip() in help_commands:
            # نام خود کاربر در نمونهٔ دستور «شخصیت» نمایش داده می‌شود؛ اگر نامی
            # ثبت نشده باشد به نام پروفایل و در نهایت به یک متن عمومی برمی‌گردد.
            help_display_name = (
                saved_name
                or getattr(sender, "first_name", None)
                or "نام شما"
            )
            insights_example = f"شخصیت {help_display_name}"
            full_help_text = (
                "📌 راهنمای روباه\n\n"
