...
# ثبت آمار پیام گروه
        ...
        if clean_text == "راهنمای امتیاز":
            ...
            def guide_u16(value):
                return len(value.encode("utf-16-le")) // 2
            guide_labels = ("🏅 راهنمای امتیاز", "🧩 حدس چیستان:", "😀 حدس ایموجی:", "🌍 حدس پرچم:", "📝 اسم فامیل (70 امتیاز یا بیشتر):", "✍️ تصحیح کلمات:", "❓ چهار گزینه‌ای:", "😂 بخند یا بباز:", "🏕 بقا:", "🧛 خون‌آشام:", "📈 پایان هر روز:", "🥇 رتبه اول:", "🥈 رتبه دوم:", "🥉 رتبه سوم:")
