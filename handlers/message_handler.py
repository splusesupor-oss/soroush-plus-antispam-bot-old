...
# ثبت آمار پیام گروه
        ...
        if clean_text.strip() in ["لیست بازی", "لیست بازی ها", "لیست بازی‌ها", "بازی ها", "بازی‌ها"]:
            games_text = (
                ...
                "🧩 معما\n"
                "از هر کاربر ۳ سوال پرسیده می‌شود و بعد از پاسخ به هر سه سوال نتیجه بازی نمایش داده می‌شود.\n\n"
                "🎯 بهترین جواب\n"
        ...
        if clean_text.strip() in help_commands:
            ...
            full_help_text = (
                ...
                "جایزه بهترین پاسخ: ۴ سکه برنز.\n\n"
                "⚔️ نبرد:\n"
                "با «نبرد» شروع و بازیکن دوم با «شرکت» می‌پیوندد.\n"
                "سوالات سخت، هر کدام ۳۰ ثانیه. بازنده با حداقل یک پاسخ صحیح: ۴ سکه برنز.\n\n"
        ...
        if clean_text == "راهنمای امتیاز":
            guide_text = (
                ...
                "🧩 معما:\nپاسخ صحیح: ۳ سکه برنز\n\n"
                "🎯 بهترین جواب:\nبهترین پاسخ: ۴ سکه برنز\n\n"
                "⚔️ نبرد:\nبازنده با حداقل یک پاسخ صحیح: ۴ سکه برنز\n\n"
                "📈 پایان هر روز:\n\n"
                "🥇 رتبه اول:\n+12 سکه\n\n"
                "🥈 رتبه دوم:\n+8 سکه\n\n"
                "🥉 رتبه سوم:\n+5 سکه"
